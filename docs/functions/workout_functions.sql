-- WORKOUT-RELATED DATABASE FUNCTIONS

-- Function: get_workout_detail_optimized
-- Purpose: Optimized function to get workout details with exercises and sets
...
-- Function: next_weight_step_kg
-- Purpose: Calculate next weight increment based on load type
