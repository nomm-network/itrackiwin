...
params AS (
  SELECT * FROM (VALUES
    ...
    ('lateral-raises', 'Lateral Raises', 'Dumbbell shoulder isolation exercise for lateral delts', 'dumbbell', 'lateral_deltoid', 'isolation', 'beginner', 74),
    ...
    ('triceps-rope-pushdown', 'Triceps Rope Pushdown', 'Cable pushdown using rope attachment for triceps isolation', 'cable-machine', 'triceps_long_head', 'isolation', 'beginner', 72),
    ('overhead-triceps-extension', 'Overhead Triceps Extension', 'Cable overhead extension for triceps long head emphasis', 'cable-machine', 'triceps_long_head', 'isolation', 'beginner', 67),
    ...
    ('lying-leg-curl', 'Lying Leg Curl', 'Hamstring curl performed lying prone on machine', 'machine', 'biceps_femoris', 'isolation', 'beginner', 68),
    ('seated-leg-curl', 'Seated Leg Curl', 'Hamstring curl performed seated with reduced lower-back demand', 'machine', 'biceps_femoris', 'isolation', 'beginner', 65),
    ...
    -- CALF EXERCISES
    ('standing-calf-raise', 'Standing Calf Raise', 'Standing calf raise to target gastrocnemius', 'machine', 'gastrocnemius_medial', 'isolation', 'beginner', 62),
    ...
    ('back-extension', 'Back Extension', 'Extension on back hyper bench targeting erectors and glutes', 'machine', 'longissimus', 'hinge', 'beginner', 63),
