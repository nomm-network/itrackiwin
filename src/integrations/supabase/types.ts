  ...
  public: {
    Tables: {
      ...
      ambassador_commission_accruals: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["agreement_id"]
            isOneToOne: false
            referencedRelation: "v_ambassador_statements"
      ...
      ambassador_commission_agreements: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["ambassador_id"]
            isOneToOne: false
            referencedRelation: "v_ambassador_summary"
      ...
      equipment_profiles: {
        ...
        Relationships: [
          {
            foreignKeyName: "equipment_profiles_equipment_id_fkey"
            columns: ["equipment_id"]
            isOneToOne: false
            referencedRelation: "equipment"
            referencedColumns: ["id"]
      ...
      mentor_areas: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["mentor_id"]
            isOneToOne: false
            referencedRelation: "v_marketplace_local_mentors"
            referencedColumns: ["mentor_profile_id"]
          },
          {
            foreignKeyName: "fk_mentor_areas_mentor"
            columns: ["mentor_id"]
            isOneToOne: false
            referencedRelation: "v_marketplace_mentors"
            referencedColumns: ["mentor_profile_id"]
          },
          {
            foreignKeyName: "fk_mentor_areas_mentor"
      ...
      mentor_categories: {
        ...
        Relationships: [
          {
            foreignKeyName: "mentor_categories_mentor_profile_id_fkey"
      ...
      user_gym_equipment_profiles: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_gym_equipment_profiles_equipment_id_fkey"
            columns: ["equipment_id"]
            isOneToOne: false
            referencedRelation: "equipment"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "user_gym_equipment_profiles_plate_profile_id_fkey"
            columns: ["plate_profile_id"]
            isOneToOne: false
            referencedRelation: "plate_profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "user_gym_equipment_profiles_stack_profile_id_fkey"
            columns: ["stack_profile_id"]
            isOneToOne: false
            referencedRelation: "stack_profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "user_gym_equipment_profiles_user_gym_id_fkey"
            columns: ["user_gym_id"]
            isOneToOne: false
            referencedRelation: "user_gyms"
            referencedColumns: ["id"]
    ...
    Views: {
      ...
      v_ambassador_commission_summary: {
        Row: {
          ...
          commission_last_month: number | null
          commission_mtd: number | null
        }
        Relationships: []
      }
      ...
      v_ambassador_summary: {
        Row: {
          ...
          user_id: string | null
          verified_deals_total: number | null
      ...
      v_gym_equipment_completeness: {
        Row: {
          ...
          overrides_coverage_pct: number | null
        }
        Relationships: []
      }
    ...
    Functions: {
      ...
      get_equipment_profile: {
        Args: { p_equipment_id: string; p_user_gym_id?: string }
        Returns: {
          plate_profile_id: string
