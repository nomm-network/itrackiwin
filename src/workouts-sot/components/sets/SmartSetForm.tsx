...
export default function SmartSetForm({ exercise, workoutExerciseId, setIndex = 1, onLogged, className, targetWeight, targetReps, feel, unilateralEnabled = false, onSettingsClick }: Props) {
  // Mount debug
  React.useEffect(() => {
