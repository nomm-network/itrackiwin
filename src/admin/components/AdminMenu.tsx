  ...
  const menuItems = [
    { 
      ...
      submenu: [
        ...
        { label: '6.1 Handle-Equipment', href: '/admin/setup/handle-equipment-compatibility' },
        { label: '6.2 Handle-Grip', href: '/admin/setup/handle-grip-compatibility' },
        { label: '6.3 Equipment Defaults', href: '/admin/setup/compatibility' },
