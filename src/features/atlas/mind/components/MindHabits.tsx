...
const habits = [
  { id: "journal", label: "Daily journaling", completed: true },
  { id: "breathwork", label: "5-min breathwork", completed: false },
  { id: "screen-free", label: "Screen-free before bed", completed: true },
];

export function MindHabits() {
  return (
