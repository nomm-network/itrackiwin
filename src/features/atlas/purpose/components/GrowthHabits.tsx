...
const habits = [
  { id: "reflection", label: "Daily reflection", completed: true },
  { id: "review", label: "Weekly goal review", completed: true },
  { id: "gratitude", label: "Gratitude journaling", completed: false },
];

export function GrowthHabits() {
  return (
    <Card className="p-6 bg-card/50 backdrop-blur border-border/50">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-lg font-semibold">Growth Habits</h2>
