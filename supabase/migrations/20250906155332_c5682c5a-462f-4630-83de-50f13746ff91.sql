-- Step 5: Analytics & Ops - KPI Views and Commission System (Corrected)

-- 1) Gym activity (members, coaches, sessions) - Fixed column references
...
-- 2) Exercise popularity per gym - Fixed to not reference status
