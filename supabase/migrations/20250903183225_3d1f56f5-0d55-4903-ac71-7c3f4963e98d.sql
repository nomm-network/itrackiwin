-- First, let's check what mentor/coach related tables exist
SELECT table_name FROM information_schema.tables 
WHERE table_schema = 'public' 
AND table_name ILIKE '%mentor%' OR table_name ILIKE '%coach%';
...
INSERT INTO public.life_categories (slug, name) VALUES
  ('fitness','Fitness'),
  ('nutrition','Nutrition'),
...
-- Assumes workout_templates(id) exists in public schema
