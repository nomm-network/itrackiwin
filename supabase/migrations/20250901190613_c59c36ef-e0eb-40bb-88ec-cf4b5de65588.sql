-- 1) Clean up any previous definition
...
BEGIN
  ...
  -- Make sure the caller can use this template (owner or public)
  IF NOT EXISTS (
    SELECT 1
...
-- 3) Permissions (so your Supabase client can call it)
GRANT EXECUTE ON FUNCTION public.start_workout(uuid) TO authenticated, anon;