-- Seed enhanced AI exercises with proper enum values and array casting
...
('Plank', 'plank', 'abs', ARRAY[]::TEXT[], ARRAY['bodyweight'], 'isolation', 'new', 1, true),
...
('Bicep Curls', 'bicep-curls', 'biceps', ARRAY[]::TEXT[], ARRAY['dumbbells'], 'isolation', 'new', 1, false),
('Tricep Extensions', 'tricep-extensions', 'triceps', ARRAY[]::TEXT[], ARRAY['dumbbells'], 'isolation', 'new', 1, false),
('Hip Thrusts', 'hip-thrusts', 'glutes', ARRAY['hamstrings'], ARRAY['bench'], 'compound', 'new', 2, false),
('Calf Raises', 'calf-raises', 'calves', ARRAY[]::TEXT[], ARRAY['bodyweight'], 'isolation', 'new', 1, true),
...
('Chest Flyes', 'chest-flyes', 'chest', ARRAY[]::TEXT[], ARRAY['dumbbells'], 'isolation', 'returning', 2, false),
('Lat Raises', 'lat-raises', 'shoulders', ARRAY[]::TEXT[], ARRAY['dumbbells'], 'isolation', 'new', 1, false),
...
('Russian Twists', 'russian-twists', 'abs', ARRAY[]::TEXT[], ARRAY['bodyweight'], 'isolation', 'new', 1, true),
