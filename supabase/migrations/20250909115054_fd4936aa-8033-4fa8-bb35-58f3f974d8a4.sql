-- Update exercises with proper muscles, body parts, movements, and grips
-- Using correct 'muscles' table instead of 'muscle_groups'

-- Update Barbell Back Squat
UPDATE exercises SET
    primary_muscle_id = (SELECT id FROM muscles WHERE slug = 'vastus_medialis'),
...
UPDATE exercises SET
    primary_muscle_id = (SELECT id FROM muscles WHERE slug = 'mid_chest'),
    secondary_muscle_group_ids = ARRAY[
...
UPDATE exercises SET
    primary_muscle_id = (SELECT id FROM muscles WHERE slug = 'triceps_long_head'),
    secondary_muscle_group_ids = ARRAY[
...
UPDATE exercises SET
    primary_muscle_id = (SELECT id FROM muscles WHERE slug = 'front_delts'),
    secondary_muscle_group_ids = ARRAY[
        (SELECT id FROM muscle_groups WHERE slug = 'triceps'),
...
UPDATE exercises SET
    primary_muscle_id = (SELECT id FROM muscles WHERE slug = 'upper_chest'),
    secondary_muscle_group_ids = ARRAY[
        (SELECT id FROM muscle_groups WHERE slug = 'shoulders'),
        (SELECT id FROM muscle_groups WHERE slug = 'triceps')
    ],
...
UPDATE exercises SET
    primary_muscle_id = (SELECT id FROM muscles WHERE slug = 'side_delts'),
    secondary_muscle_group_ids = ARRAY[
        (SELECT id FROM muscle_groups WHERE slug = 'traps')
    ],
    body_part_id = (SELECT id FROM body_parts WHERE slug = 'arms'),
