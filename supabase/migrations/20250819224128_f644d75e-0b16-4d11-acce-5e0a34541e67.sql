-- Fix security definer view issues by adding proper RLS policies to views

-- Drop existing views and recreate them as SECURITY INVOKER
DROP VIEW IF EXISTS public.v_body_parts_with_translations;
DROP VIEW IF EXISTS public.v_equipment_with_translations;
DROP VIEW IF EXISTS public.v_muscle_groups_with_translations;
DROP VIEW IF EXISTS public.v_muscles_with_translations;
DROP VIEW IF EXISTS public.v_exercises_with_translations;
DROP VIEW IF EXISTS public.v_workout_templates_with_translations;
