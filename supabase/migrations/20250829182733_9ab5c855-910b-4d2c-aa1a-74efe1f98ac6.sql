-- Add missing movement_pattern enum values to match exercise slugs
ALTER TYPE movement_pattern ADD VALUE 'press';
ALTER TYPE movement_pattern ADD VALUE 'front_raise';
