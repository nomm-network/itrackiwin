-- Fix start_workout function - use correct column name 'name' instead of 'title'
...
DECLARE
  ...
  workout_title text;
BEGIN
  -- Get name from template if provided (workout_templates has 'name' not 'title')
  IF p_template_id IS NOT NULL THEN
    SELECT wt.name INTO workout_title 
