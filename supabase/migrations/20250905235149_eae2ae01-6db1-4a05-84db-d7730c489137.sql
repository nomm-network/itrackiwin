-- Drop and recreate functions to avoid parameter default conflicts
...
-- Update start_workout to store both UUID pointer and JSON metadata
CREATE OR REPLACE FUNCTION public.start_workout(p_template_id uuid)
RETURNS uuid
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path TO 'public'
