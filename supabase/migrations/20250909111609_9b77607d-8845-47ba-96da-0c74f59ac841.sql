...
-- Disable the auto-naming trigger temporarily
ALTER TABLE exercises DISABLE TRIGGER exercises_autoname_tg;
...
-- Re-enable the auto-naming trigger
ALTER TABLE exercises ENABLE TRIGGER exercises_autoname_tg;
