-- Drop the existing compute_readiness_score function completely first
DROP FUNCTION IF EXISTS public.compute_readiness_score(numeric,numeric,numeric,numeric,numeric,numeric,boolean,boolean,boolean);

-- Now proceed with the full surgical fix
