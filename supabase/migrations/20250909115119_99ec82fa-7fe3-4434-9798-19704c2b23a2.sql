...
UPDATE exercises SET
    primary_muscle_id = (SELECT id FROM muscles WHERE slug = 'rectus_femoris'), -- Quads primary
...
UPDATE exercises SET
    primary_muscle_id = (SELECT id FROM muscles WHERE slug = 'mid_chest'), -- Chest primary
    secondary_muscle_group_ids = ARRAY[
...
UPDATE exercises SET
    primary_muscle_id = (SELECT id FROM muscles WHERE slug = 'triceps_lateral_head'), -- Triceps primary
    secondary_muscle_group_ids = ARRAY[
...
UPDATE exercises SET
    primary_muscle_id = (SELECT id FROM muscles WHERE slug = 'front_delts'), -- Shoulders primary
    secondary_muscle_group_ids = ARRAY[
        (SELECT id FROM muscle_groups WHERE slug = 'triceps'),
...
-- Update Face Pulls
UPDATE exercises SET
    primary_muscle_id = (SELECT id FROM muscles WHERE slug = 'rear_delts'), -- Rear delts primary
    secondary_muscle_group_ids = ARRAY[
        (SELECT id FROM muscle_groups WHERE slug = 'traps'),
...
UPDATE exercises SET
    primary_muscle_id = (SELECT id FROM muscles WHERE slug = 'upper_chest'), -- Upper chest primary
    secondary_muscle_group_ids = ARRAY[
        (SELECT id FROM muscle_groups WHERE slug = 'shoulders'),
        (SELECT id FROM muscle_groups WHERE slug = 'triceps')
    ],
...
UPDATE exercises SET
    primary_muscle_id = (SELECT id FROM muscles WHERE slug = 'side_delts'), -- Side delts primary
    secondary_muscle_group_ids = ARRAY[
        (SELECT id FROM muscle_groups WHERE slug = 'traps')
    ],
    body_part_id = (SELECT id FROM body_parts WHERE slug = 'arms'),
...
UPDATE exercises SET
    primary_muscle_id = (SELECT id FROM muscles WHERE slug = 'triceps_long_head'), -- Triceps primary
    secondary_muscle_group_ids = ARRAY[
        (SELECT id FROM muscle_groups WHERE slug = 'shoulders')
    ],
    body_part_id = (SELECT id FROM body_parts WHERE slug = 'arms'),
