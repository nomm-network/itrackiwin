...
-- Create program_templates table (using training_program_blocks as reference)
-- Since training_program_blocks already exists, we'll use it as our program_templates
...
RETURNS TABLE(template_id uuid, position integer)
LANGUAGE plpgsql
SECURITY DEFINER
