-- Fix the program_creator enum value to use 'bro_ai' instead of 'user'
...
BEGIN
  ...
  v_goal_enum := CASE p_goal
    ...
    WHEN 'endurance' THEN 'general_fitness'::program_goal
  ...
  v_exp_enum := CASE p_experience_level
    ...
    WHEN 'beginner' THEN 'new'::experience_level
