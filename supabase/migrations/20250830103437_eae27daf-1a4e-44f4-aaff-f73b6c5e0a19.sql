-- Create or replace the v_exercises_with_translations view
CREATE OR REPLACE VIEW v_exercises_with_translations AS
SELECT 
  e.*,
  et.name as translation_name,
  et.description as translation_description,
  et.language_code,
