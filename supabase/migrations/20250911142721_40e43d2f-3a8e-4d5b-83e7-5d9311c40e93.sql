...
-- Insert default plate profiles if they don't exist
INSERT INTO public.plate_profiles (name, default_unit, notes)
VALUES 
  ('EU Standard (KG)', 'kg', 'Standard European metric plates'),
  ('US Standard (LB)', 'lb', 'Standard US imperial plates')
