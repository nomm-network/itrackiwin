-- Fix the admin functions and create the missing view

-- First, let's create the missing v_admin_mentors_overview view
...
-- Update admin_get_users_overview to work properly without strict admin check for now
-- We'll modify it to be more permissive since we're in development
