...
BEGIN
  ...
  DROP POLICY IF EXISTS "Allow all access to spatial reference systems" ON public.spatial_ref_sys;
  
  CREATE POLICY "Allow all access to spatial reference systems"
