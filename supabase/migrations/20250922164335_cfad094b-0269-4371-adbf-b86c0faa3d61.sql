-- Fix set_log function - remove call to non-existent function
...
BEGIN
  ...
  -- Insert the new workout set with all correct column mappings
  INSERT INTO workout_sets (
    ...
    COALESCE((p_payload->>'set_kind')::set_type, 'normal'::set_type),
