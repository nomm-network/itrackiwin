...
DROP FUNCTION public.generate_ai_program(text,text,integer,text,text[],text[],integer,uuid);
DROP FUNCTION IF EXISTS public.generate_ai_program(text,text,integer,text,text[],text[],integer);

-- Create the function with auth.uid() handling
