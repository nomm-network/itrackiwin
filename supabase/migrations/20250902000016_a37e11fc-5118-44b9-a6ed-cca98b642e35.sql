-- Add RPC function to pre-seed workout targets
...
BEGIN
  ...
  */
  ...
  last_set AS (
    ...
    ORDER BY wex.exercise_id, ws.created_at DESC
  ),
  prs AS (
...
-- Update start_workout to call the target seeding function
