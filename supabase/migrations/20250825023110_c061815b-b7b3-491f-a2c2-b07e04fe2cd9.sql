-- Fix the views that were broken by removing slug column
...
-- Recreate v_exercises_with_translations without slug
...
GROUP BY e.id, e.body_part, e.body_part_id, e.primary_muscle_id, 
...
-- Recreate v_exercises_for_coach using translations, without slug
...
-- Recreate v_safe_exercises_for_user using translations, without slug
