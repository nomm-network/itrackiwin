-- CORRECTED EXERCISE SEED SCRIPT
-- Using actual anatomical muscle slugs from research
...
-- 2) Define exercises with CORRECT muscle slugs based on research
params AS (
  VALUES
  -- ========= CHEST =========
  ...
  ('lateral-raise-dumbbell','Lateral Raise (DB)','Side raise for lateral delts.','shoulders','lateral_deltoid','dumbbell',NULL, ARRAY['neutral'], ARRAY['trapezius'], 'vertical_push', NULL, 34),
  ...
  -- ========= ARMS =========
  ('barbell-curl','Barbell Curl','Straight bar curl for biceps.','arms','biceps_brachii_long_head','barbell',NULL, ARRAY['underhand'], ARRAY['forearms'], 'vertical_pull', 20, 24),
  ('ez-bar-curl','EZ-Bar Curl','EZ bar curl, wrist-friendly.','arms','biceps_brachii_long_head','barbell',NULL, ARRAY['underhand'], ARRAY['forearms'], 'vertical_pull', 20, 36),
  ('dumbbell-hammer-curl','Hammer Curl (DB)','Neutral-grip curl.','arms','brachialis','dumbbell',NULL, ARRAY['neutral'], ARRAY['forearms'], 'vertical_pull', NULL, 42),
  ...
  ('leg-extension','Leg Extension','Quad isolation machine.','legs','rectus_femoris','machine',NULL, ARRAY['overhand'], ARRAY[''], 'squat', NULL, 71),
  ('seated-leg-curl','Seated Leg Curl','Hamstring curl machine.','legs','biceps_femoris','machine',NULL, ARRAY['overhand'], ARRAY['glutes'], 'hinge', NULL, 77),
  ...
  -- ========= CALVES =========
  ('calf-raise-standing','Standing Calf Raise','Gastrocnemius dominant.','calves','gastrocnemius_medial','machine',NULL, ARRAY['overhand'], ARRAY[''], 'vertical_push', NULL, 45),
  ('calf-raise-seated','Seated Calf Raise','Soleus-biased seated raise.','calves','soleus','machine',NULL, ARRAY['overhand'], ARRAY[''], 'vertical_push', NULL, 73),

  -- ========= CORE =========
  ('plank','Plank','Anti-extension core hold.','core','rectus_abdominis','bodyweight',NULL, ARRAY['neutral'], ARRAY['obliques'], 'anti_extension', NULL, 41),
  ...
  ('cable-crunch','Cable Crunch','Kneeling cable flexion.','core','rectus_abdominis','cable','rope', ARRAY['rope_neutral'], ARRAY['obliques'], 'vertical_pull', NULL, 63)
),
