-- Step 1: Inspect current constraints and indexes on personal_records
-- This will help us understand what exists
...
-- Step 2: Drop old constraint and create grip-aware unique constraint
...
-- Step 3: Update the log_simple_workout_set function to use correct ON CONFLICT
...
-- Step 4: Add safety constraint for workout_sets uniqueness
...
-- Log success
RAISE NOTICE 'Successfully updated personal_records constraints and log_simple_workout_set function';