-- Update start_workout to support program rep ranges
  ...
  IF p_template_id IS NOT NULL THEN
    ...
    LOOP
      INSERT INTO public.workout_exercises (
        ...
        -- Use program rep ranges if available, otherwise NULL
        CASE WHEN p_program_id IS NOT NULL THEN v_program_rep_min ELSE NULL END,
        CASE WHEN p_program_id IS NOT NULL THEN v_program_rep_max ELSE NULL END,
